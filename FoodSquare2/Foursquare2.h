...
#define FS2_OAUTH_KEY    (FOURSQUARE_CLIENT_ID)
#endif

#ifndef FS2_OAUTH_SECRET
#define FS2_OAUTH_SECRET (FOURSQUARE_CLIENT_SECRET)
#endif

//2, don't forget to added app url in your info plist file CFBundleURLTypes
#ifndef FS2_REDIRECT_URL
#define FS2_REDIRECT_URL FOURSQUARE_REDIRECT_URL
#endif

//3 update this date to use up-to-date Foursquare API
#ifndef FS2_API_VERSION
#define FS2_API_VERSION (FOURSQUARE_API_VERSION)
#endif


#define FS2_API_BaseUrl FOURSQUARE_BASE_URL
